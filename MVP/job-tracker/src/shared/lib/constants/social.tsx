...
import IconTg from "@shared/assets/svg/icon-tg.svg?react";
import IconWhatsApp from "@shared/assets/svg/icon-whatsapp.svg?react";
import IconMail from "@shared/assets/svg/icon-google-mail.svg?react";
